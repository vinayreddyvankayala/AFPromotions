...
public class Promotion extends AppCompatActivity {
    ...
    final int MY_PERMISSIONS_REQUEST = 201;
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (isNetworkAvailable()) {
                ...
                if(prefs.getBoolean("dataCached",false)) {
                    ArrayList<Promotions> pObjects = new ArrayList<Promotions>();
                    pObjects = helper.getAllPromotions();
                    text_1.setText(pObjects.get(0).getTitle());
                    image_1.setImageBitmap(Util.loadBitmap(getApplicationContext(), pObjects.get(0).getTitle()));
                    text_2.setText(pObjects.get(1).getTitle());
                    image_2.setImageBitmap(Util.loadBitmap(getApplicationContext(), pObjects.get(1).getTitle()));
                }
            }
        }
    }
            ...
            case MY_PERMISSIONS_REQUEST: {
                if (grantResults.length > 0
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        Toast.makeText(this,"Permission to access storage required to save images.",Toast.LENGTH_LONG).show();
                        ActivityCompat.requestPermissions(this,
                                new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                MY_PERMISSIONS_REQUEST);
                    }else {
                        Toast.makeText(this, "Permission to access storage denied.Exiting.", Toast.LENGTH_LONG).show();
                        this.finish();
                    }
                }
    ...
    private class GetImage extends AsyncTask<String,Void,String>{
        ...
        protected String doInBackground(String... params) {
            ...
            for (int i=0;i<urls.size();i++) {
                try {
                    ...
                    FileOutputStream output =
                            getApplicationContext().openFileOutput( promotionsObjects.get(i).getTitle(), Context.MODE_PRIVATE);
            ...
            editor.putBoolean("dataCached",true);
            editor.apply();
        ...
        protected void onPostExecute(String s) {
            ...
            image_1.setImageBitmap(Util.loadBitmap(getApplicationContext(),promotionsObjects.get(0).getTitle()));
            text_2.setText(promotionsObjects.get(1).getTitle());
            image_2.setImageBitmap(Util.loadBitmap(getApplicationContext(),promotionsObjects.get(1).getTitle()));
        }
    }
